...
export const createLabourer =
  createAsyncThunk(
    ...
    async (
      ...
      try {
        return await createLabourerApi(
          labourerData,
        );
      } catch (error) {
        return rejectWithValue(
          getErrorMessage(
            error,
            'Failed to create labourer profile',
          ),
        );
      }
    },
...
export const getAllLabourers =
  createAsyncThunk(
    ...
    async (
      ...
      try {
        return await getAllLabourersApi(
          params,
        );
      } catch (error) {
        return rejectWithValue(
...
export const getMyLabourerProfile =
  createAsyncThunk(
...
export const getLabourerById =
  createAsyncThunk(
    ...
    async (
      ...
      try {
        return await getLabourerByIdApi(
          labourerId,
        );
      } catch (error) {
        return rejectWithValue(
...
export const updateMyLabourerProfile =
  createAsyncThunk(
    ...
    async (
      ...
      try {
        return await updateMyLabourerProfileApi(
          labourerData,
        );
      } catch (error) {
        return rejectWithValue(
...
const labourerSlice = createSlice({
  ...
  extraReducers: builder => {
      ...
      .addCase(
        ...
        (state, action) => {
          ...
          state.message =
            ...
            'Labourer profile created successfully';

          state.myProfile =
            action.payload?.labourer ||
            null;
    ...
    builder
      ...
      .addCase(
        getAllLabourers.fulfilled,
        (state, action) => {
          state.isLoadingLabourers = false;

          state.labourers =
            action.payload?.labourers ||
            action.payload?.data ||
            [];
    ...
    builder
      ...
      .addCase(
        getMyLabourerProfile.fulfilled,
        (state, action) => {
          state.isLoadingProfile = false;
    ...
    builder
      ...
      .addCase(
        getLabourerById.fulfilled,
        (state, action) => {
          state.isLoading = false;

          state.selectedLabourer =
            action.payload?.labourer ||
            null;
    ...
    builder
      .addCase(
        updateMyLabourerProfile.pending,
        state => {
      ...
      .addCase(
        updateMyLabourerProfile.fulfilled,
        (state, action) => {
          state.isUpdating = false;
      ...
      .addCase(
        updateMyLabourerProfile.rejected,
        (state, action) => {
          state.isUpdating = false;
          state.updateSuccess = false;
    ...
    builder
      .addCase(
        deactivateMyLabourerProfile.pending,
        state => {
          state.error = null;
        },
      )
      ...
      .addCase(
        deactivateMyLabourerProfile.fulfilled,
        (state, action) => {
          state.message =
            action.payload?.message ||
      ...
      .addCase(
        deactivateMyLabourerProfile.rejected,
        (state, action) => {
          state.error =
            action.payload ||
            'Failed to deactivate labourer profile';
    ...
    builder
      .addCase(
        activateMyLabourerProfile.pending,
        state => {
          state.error = null;
        },
      )
      ...
      .addCase(
        activateMyLabourerProfile.fulfilled,
        (state, action) => {
          state.message =
            action.payload?.message ||
      ...
      .addCase(
        activateMyLabourerProfile.rejected,
        (state, action) => {
          state.error =
            action.payload ||
            'Failed to activate labourer profile';
