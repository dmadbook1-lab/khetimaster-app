...
export default function ScreenHeader({title, subtitle, onBack, rightIcon: RightIcon, rightBadge, onRightPress}) {
  return (
...
const styles = StyleSheet.create({
  ...
  title: {fontSize: rf(16), fontWeight: '900', color: COLORS.DARK},
  subtitle: {marginTop: 3, fontSize: rf(11), fontWeight: '500', color: COLORS.MUTED, textAlign: 'center'},
});