  ...
  return (
    <TouchableOpacity
      ...
      <ImageBackground
        ...
        resizeMode="cover">
        {/* Full white overlay for readability */}
        <LinearGradient
          colors={[
        ...
        <WeatherStat Icon={Droplets} color="#2563EB" value="48%" label="Humidity" />
        <WeatherStat Icon={Wind} color="#0EA5E9" value="12 km/h" label="Wind Speed" />
        <WeatherStat Icon={Navigation} color="#475569" value="WSW" label="Direction" />
      </ImageBackground>
    </TouchableOpacity>
  );
}
