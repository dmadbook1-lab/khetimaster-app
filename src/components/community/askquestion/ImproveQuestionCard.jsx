...
import {Sparkles, ChevronDown, Check, ChevronsDown} from 'lucide-react-native';
  ...
  return (
    <View style={styles.wrap}>
      ...
      <View style={styles.improvedHeader}>
        <ChevronsDown size={rf(11)} color={COLORS.DARK_GREEN} strokeWidth={2.4} />
      ...
      <TouchableOpacity activeOpacity={0.9} onPress={onUse} style={styles.useBtn}>
...
const styles = StyleSheet.create({
  ...
  title: {fontSize: rf(13), fontWeight: '900', color: COLORS.DARK},
  label: {
    marginTop: 14,
    fontSize: rf(9.5),
    fontWeight: '900',
  ...
  improvedHeader: {flexDirection: 'row', alignItems: 'center', gap: 5},
  improvedLabel: {
    fontSize: rf(9.5),
    fontWeight: '900',
    color: COLORS.DARK_GREEN,
  ...
  useText: {fontSize: rf(12), fontWeight: '900', color: '#FFFFFF'},
});