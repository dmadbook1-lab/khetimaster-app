...
const styles = StyleSheet.create({
  ...
  title: {fontSize: rf(12.5), fontWeight: '900', color: COLORS.DARK},
  sub: {marginTop: 2, fontSize: rf(10), fontWeight: '500', color: COLORS.MUTED},
  percent: {fontSize: rf(14), fontWeight: '900', color: COLORS.DARK_GREEN},
  barTrack: {
    marginTop: 12,
    height: 6,
    borderRadius: 3,
  ...
  barFill: {height: '100%', backgroundColor: COLORS.DARK_GREEN, borderRadius: 3},
});