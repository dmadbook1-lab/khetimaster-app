...
export default function CommunityTabs({navigation, activeRoute, onTabChange}) {
...
const styles = StyleSheet.create({
  ...
  activePill: {backgroundColor: COLORS.DARK_GREEN},
  pillText: {fontSize: rf(12), fontWeight: '900', color: '#64748B'},
