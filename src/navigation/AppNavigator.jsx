...
// import OwnerRegistrationScreen from '../screens/Machinery-rentals/OwnerRegistrationScreen'; 
  ...
  return (
    <NavigationContainer theme={navigationTheme}>
      <Stack.Navigator
        ...
        <Stack.Screen name="ProvideServiceStep1" component={ProvideServiceStep1Screen} />
        <Stack.Screen name="ProvideServiceStep2" component={ProvideServiceStep2Screen} />
        <Stack.Screen name="ProvideServiceStep3" component={ProvideServiceStep3Screen} />
        <Stack.Screen name="ProvideServiceStep4" component={ProvideServiceStep4Screen} />
        <Stack.Screen name="ProvideServiceSuccess" component={ProvideServiceSuccessScreen} options={{ gestureEnabled: false }} />


        <Stack.Screen name="WorkerDetails" component={WorkerDetailsScreen} />
        <Stack.Screen name="LabourBookingDetails" component={LabourBookingDetailsScreen} />
        <Stack.Screen name="ConfirmLabourBooking" component={ConfirmLabourBookingScreen} />
        <Stack.Screen name="LabourBookingSuccess" component={LabourBookingSuccessScreen} />
        ...
        <Stack.Screen name="FindWorkSuccess" component={FindWorkSuccessScreen} />
        <Stack.Screen
          name="MyBookings"
        ...
        />
          <Stack.Screen
  name="LabourRequests"
  component={LabourRequestsScreen}
/>

        <Stack.Screen name="DroneServices" component={DroneServicesScreen} />
        <Stack.Screen name="DroneServiceDetails" component={DroneServiceDetailsScreen} />
        <Stack.Screen name="BookDroneService" component={BookDroneServiceScreen} />
        <Stack.Screen name="ConfirmDroneBooking" component={ConfirmDroneBookingScreen} />
        <Stack.Screen name="DroneBookingSuccess" component={DroneBookingSuccessScreen} options={{ gestureEnabled: false }} />
