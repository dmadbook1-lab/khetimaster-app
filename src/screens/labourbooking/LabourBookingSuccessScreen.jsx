...
|
| because React Native Image requires either:
|
| require(...)
|
| OR
...
const getImageSource = image => {
  ...
  // Already formatted React Native source
  if (
    typeof image === 'object' &&
    image.uri
  ) {
...
export default function LabourBookingSuccessScreen({
  navigation,
  route,
}) {
  /*
  ...
  */
  ...
  const labourForm = useSelector(
    state => state.labour?.formData || {},
  );

  const labourerState = useSelector(
  ...
  |--------------------------------------------------------------------------
  |
  | Prefer actual navigation response data.
  |
  */
  ...
  */
  ...
  const workerImage = getImageSource(
      ...
      >
        ...
        >
          ...
          >
            ...
            <View style={styles.aiInfoBox}>
              <Text style={styles.aiInfoText}>
                ...
                Keep the farm ready before the
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              // Later connect this to live worker tracking.
            }}
          >
            <MapPin
              size={rf(17)}
