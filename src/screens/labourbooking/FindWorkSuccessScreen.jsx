...
export default function FindWorkSuccessScreen({
  navigation,
  route,
}) {
  ...
  const skills = Array.isArray(labourer?.skills)
    ? labourer.skills
    : [];
    ...
    <SafeAreaView
      ...
      <ScrollView
        ...
        <View style={styles.tipCard}>
          ...
          <View style={{flex: 1, marginLeft: 9}}>
            ...
            <Text style={styles.tipText}>
              Accept work quickly when farmers
              send requests.
            </Text>
        ...
        <TouchableOpacity
          activeOpacity={0.9}
          onPress={() =>
            navigation.navigate('FindWorkStep1')
          }
