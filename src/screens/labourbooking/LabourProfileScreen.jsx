...
export default function LabourProfileScreen({navigation}) {
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyTitle}>
            No Labour Profile Found
          </Text>

          <Text style={styles.emptyText}>
            You haven't created a labour profile yet.
            Create one to start finding farming work
            near you.
          </Text>
  ...
  const preferredWork =
    Array.isArray(profile?.preferredWork)
  ...
  const wage =
    ...
    profile?.expectedWage !== ''
      ? `₹${Number(profile.expectedWage).toLocaleString(
          'en-IN',
