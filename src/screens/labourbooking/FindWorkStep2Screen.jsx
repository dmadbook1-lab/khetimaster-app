...
export default function FindWorkStep2Screen({
  navigation,
}) {
    ...
    <SafeAreaView
      ...
      <ScrollView
        ...
        <Text style={styles.subtitle}>
          Select all farming work you can do.
        </Text>
        ...
        <View style={styles.grid}>
          {WORK_TYPES.map(work => {
            ...
            return (
              <TouchableOpacity
                ...
                activeOpacity={0.85}
                onPress={() =>
                  toggleWorkType(work.id)
                }
                style={[
                  styles.workCard,
                  active &&
                    styles.activeWorkCard,
                ]}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Alert.alert(
                'Other Work',
                'Other work type can be added later.',
              )
            }
            style={[
              styles.workCard,
