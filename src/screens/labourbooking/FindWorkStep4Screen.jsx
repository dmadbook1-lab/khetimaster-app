...
export default function FindWorkStep4Screen({
  navigation,
}) {
  ...
  const [
    workerArrangement,
    setWorkerArrangement,
  ] = useState(
    formData.workerArrangement ||
      'single',
  );
  ...
  const validate = () => {
    if (!formData.fullName?.trim()) {
      Alert.alert(
        'Missing Details',
        'Please enter your name in Step 3.',
      );
      return false;
    }
    ...
    if (!formData.village?.trim()) {
      Alert.alert(
        'Missing Village',
        'Please enter your village in Step 3.',
      );
      return false;
    }
    ...
    if (!displayWage.trim()) {
      Alert.alert(
        'Wage Required',
        'Please enter your expected wage.',
      );
      return false;
    }
  ...
  const handleStartWorking =
    async () => {
      ...
      try {
        ...
        // Reset the wizard AFTER successful
        // navigation request.
        setTimeout(() => {
          dispatch(
            resetLabourForm(),
    ...
    <SafeAreaView
      ...
      <ScrollView
        ...
        <Text style={styles.subtitle}>
          Set your availability, wage and
          work preferences.
        </Text>
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      active &&
                        styles.activeArrangementCard,
                    ]}>

                    <View
                      style={
                        styles.arrangementIcon
                      }>
