...
const formatBookingDate = value => {
  ...
  /*
   * If the previous screen already sends
   * something like "30 June 2026",
   * keep it unchanged.
   */
  if (
    typeof value === 'string' &&
...
export default function LabourBookingDetailsScreen({
  ...
  */
  ...
  const bookingDate =
    formatBookingDate(rawBookingDate);
  ...
  */
  ...
  |
  | The booking is now sent to:
  |
  | createLabourBookingApi(bookingData)
  |
  */
    ...
    */
    ...
    try {
      ...
      */
      ...
      |--------------------------------------------------------------------------
      |
      | labourerId is the MOST IMPORTANT FIELD.
      |
      */
  ...
  // IMPORTANT: backend requires this field
  workType: activity,
  ...
  time:
    workingHours !== 'Time not specified'
      ? workingHours
      : '',
  ...
  paymentMethodId: selectedPayment,
      ...
      */
      ...
      |--------------------------------------------------------------------------
      |
      | Different controller implementations may return:
      |
      | response.booking
      | response.data
      ...
      */
      ...
      const booking = {
        /*
        | Prefer backend ID.
        | Fall back only if backend doesn't return one.
        */
          ...
          <View
            ...
            <Text
              ...
              <Text
                ...
                12 hours before work starts
              </Text>{' '}
              at no cost. Late cancellations
              may incur a partial charge of
              up to ₹200.
            </Text>
