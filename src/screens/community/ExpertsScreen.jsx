...
import {
  ...
  PAGE_PADDING,
  width,
} from '../../components/community/theme';
    ...
    >
            ...
            <View style={styles.featuredImageWrap}>
              ...
              {e.verified && (
                <View style={styles.featuredVerified}>
                  <BadgeCheck size={rf(10)} color="#FFFFFF" strokeWidth={2.4} />
      ...
      >
        ...
        <Text style={styles.tipText}>
          Soak seeds in cow urine solution for 12 hours before sowing to improve
          germination rate and protect against soil-borne diseases.
        </Text>
