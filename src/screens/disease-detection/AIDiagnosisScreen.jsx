...
const SUMMARY_ITEMS = [
    { id: 'crop', label: 'Crop', value: 'Maize / Corn', Icon: Sprout },
    { id: 'area', label: 'Affected Area', value: '~35%', Icon: Grid3x3 },
    { id: 'disease', label: 'Disease', value: 'Leaf Spot', Icon: Code2 },
    { id: 'severity', label: 'Severity', value: 'Moderate', Icon: AlertTriangle },
];
...
const styles = StyleSheet.create({
    ...
    completedTextBox: { flex: 1 },
    completedTitle: { fontSize: rf(11), fontWeight: '900', color: DARK },
    completedSubtitle: {
        marginTop: 2,
        fontSize: rf(9),
        fontWeight: '500',
    ...
    diagnosisTop: { flexDirection: 'row', alignItems: 'center', gap: 14 },
    confidenceCircleWrap: { alignItems: 'center', justifyContent: 'center' },
    confidenceTextBox: { position: 'absolute', alignItems: 'center' },
    confidencePercent: { fontSize: rf(15), fontWeight: '900', color: DARK_GREEN },
    confidenceLabel: {
        marginTop: 1,
        fontSize: rf(7),
        fontWeight: '600',
    ...
    diagnosisTextBox: { flex: 1 },
    detectedLabel: { fontSize: rf(8), fontWeight: '900', color: DARK_GREEN },
    diseaseName: {
        marginTop: 4,
        fontSize: rf(19),
        fontWeight: '900',
    ...
    severityText: { fontSize: rf(8), fontWeight: '900', color: ORANGE },
    ...
    footerLeftText: { fontSize: rf(9), fontWeight: '600', color: MUTED },
    footerRight: { flexDirection: 'row', alignItems: 'center', gap: 5 },
    footerRightText: { fontSize: rf(9), fontWeight: '900', color: DARK_GREEN },
    ...
    affectedImage: { width: '100%', height: 200 },
    ...
    affectedDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: ORANGE },
    affectedText: { fontSize: rf(8), fontWeight: '900', color: '#FFFFFF' },
    ...
    summaryTextBox: { flex: 1, marginLeft: 10 },
    summaryLabel: { fontSize: rf(8), fontWeight: '600', color: MUTED },
    summaryValue: {
        marginTop: 2,
        fontSize: rf(11),
        fontWeight: '900',
    ...
    aiConfidenceTop: { flexDirection: 'row', alignItems: 'center' },
    aiConfidenceIcon: {
        width: 34,
        height: 34,
        borderRadius: 17,
    ...
    aiConfidenceTextBox: { flex: 1, marginLeft: 11 },
    aiConfidenceTitle: { fontSize: rf(12), fontWeight: '900', color: '#FFFFFF' },
    ...
    aiConfidencePercent: { fontSize: rf(20), fontWeight: '900', color: '#FFFFFF' },
