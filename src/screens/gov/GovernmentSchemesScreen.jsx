...
const POPULAR = [
  ...
  },
  {
    ...
    desc: 'Crop insurance scheme for...',
    icon: Users,
    bg: '#FFEDD5',
    color: COLORS.ORANGE,
  },
  {
    ...
    desc: 'Easy credit for farmers at...',
    icon: CreditCard,
    bg: '#DBEAFE',
    color: COLORS.BLUE,
  },
          ...
          >
            ...
            <View style={styles.heroBtnRow}>
              <TouchableOpacity
                activeOpacity={0.9}
                onPress={() =>
                  navigation?.navigate(GOV_ROUTES.ELIGIBILITY_CHECK)
                }
