        ...
        <SafeAreaView style={styles.safeArea} edges={['top']}>
            ...
            <View style={styles.mapWrap}>
                ...
                <View style={styles.mapControls}>
                    <TouchableOpacity style={styles.mapBtn} onPress={() => sendToMap('locate')}>
                        <LocateFixed size={21} color={GREEN} />
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.mapBtn} onPress={() => sendToMap('toggleLayer')}>
                        <Layers size={21} color={GREEN} />
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.mapBtn} onPress={() => sendToMap('zoomIn')}>
                        <Plus size={23} color={GREEN} />
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.mapBtn} onPress={() => sendToMap('zoomOut')}>
            ...
            {!drawerVisible && (
                <View style={styles.bottomAction}>
                    <TouchableOpacity style={styles.undoMini} onPress={() => sendToMap('undo')}>
            ...
            {drawerVisible && (
                <View style={styles.drawerOverlay}>
                    ...
                    <Animated.View
                        style={[styles.summarySheet, { transform: [{ translateY: drawerAnim }] }]}>
                        <View style={styles.sheetHandle} />

                        <Text style={styles.summaryTitle}>FIELD SUMMARY</Text>

                        <View style={styles.summaryRow}>
                            <SummaryCard label="Area" value={area.toFixed(2)} unit="Hectares" />
                            <SummaryCard label="Points" value={String(points.length)} unit="Boundary" />
                            <SummaryCard label="Perimeter" value={`~${Math.round(perimeter)}`} unit="Meters" />
                        </View>
