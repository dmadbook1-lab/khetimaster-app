    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      >
        ...
        <View style={styles.toggleRow}>
          ...
          >
            <View style={[styles.radio, available && styles.radioActive]}>
              {available && <View style={styles.radioDot} />}
            </View>
            <Text
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.replace('ProvideServiceSuccess')}
        >
