...
export default function ConfirmMachineryBookingScreen({ navigation, route }) {
  ...
  const selectedImplements = route?.params?.selectedImplements || [
    'Rotavator',
    'Cultivator',
  ];
  ...
  const taxes = 130;
  const grandTotal =
    rentalTotal + operatorTotal + transportCharge + platformFee + taxes;
  ...
  const handleConfirmBooking = () => {
    ...
    navigation.replace('MachineryBookingSuccess', {
      ...
      selectedImplements,
      selectedPayment,
      paymentMethod: selectedPaymentMethod?.title || 'UPI',
      rentalTotal,
      operatorTotal,
      transportCharge,
      platformFee,
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      ...
      >
        ...
        <Text style={styles.sectionTitle}>Selected Implements</Text>

        <View style={styles.implementsRow}>
          {selectedImplements.map(item => (
            <View key={item} style={styles.implementPill}>
              <View style={styles.implementDot} />

              <Text style={styles.implementText}>{item}</Text>
            </View>
          ))}
        </View>
        ...
        >
          <View
            style={[
              ...
              termsAccepted && styles.activeTermsCheckbox,
            ]}
          >
            {termsAccepted && (
          ...
          <Text style={styles.termsText}>
            I agree to the{' '}
            <Text style={styles.termsLink}>KhetiMaster Booking Terms</Text>,
            cancellation policy, and confirm the above details are correct.
          </Text>
        </TouchableOpacity>
      </ScrollView>
      ...
      <View style={styles.bottomBar}>
        ...
        <TouchableOpacity
          ...
          style={[
            ...
            !termsAccepted && styles.disabledConfirmButton,
          ]}
        >
          <Text style={styles.confirmButtonText}>Confirm Booking</Text>

          <Check size={rf(18)} color="#FFFFFF" strokeWidth={2.6} />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
      ...
      <View style={styles.machineContent}>
        <View style={styles.machineTitleRow}>
          ...
          <View style={styles.verifiedPill}>
            <BadgeCheck size={rf(10)} color={DARK_GREEN} strokeWidth={2.5} />
        ...
        <View style={styles.machineMetaRow}>
          ...
          <Text style={styles.reviewText}>({machine.reviews})</Text>

          <MapPin size={rf(12)} color={ORANGE} strokeWidth={2.3} />
...
function BookingDetailsCard({ selectedTime, hours, includeOperator }) {
  const bookingRows = [
    {
      id: 'date',
      label: 'DATE',
    ...
    },
    {
      id: 'time',
      label: 'START TIME',
      value: selectedTime === '8' ? '8:00 AM' : `${selectedTime}:00 AM`,
      Icon: Clock3,
    },
    {
      id: 'duration',
        ...
        return (
          ...
          >
            <View style={styles.detailIconBox}>
              <Icon size={rf(20)} color="#FFFFFF" strokeWidth={2.3} />
            </View>
            ...
            <View style={styles.detailContent}>
              ...
              <Text
                style={[
                  styles.detailValue,
                  item.green && styles.greenDetailValue,
                ]}
              >
                {item.value}
              </Text>
    ...
    <View style={styles.locationCard}>
      <View style={styles.locationTopRow}>
        <View style={styles.locationIconBox}>
          <MapPin size={rf(22)} color="#FFFFFF" strokeWidth={2.4} />
        </View>
        ...
        <View style={styles.locationContent}>
          ...
          <Text style={styles.locationAddress}>
            Village Khadki, Aurangabad, Maharashtra 431001
          </Text>
      ...
      <TouchableOpacity
        activeOpacity={0.88}
        onPress={() =>
          Alert.alert('View on Map', 'Farm map can be opened here.')
        }
        style={styles.mapButton}
      >
        <MapPin size={rf(16)} color="#FFFFFF" strokeWidth={2.4} />
  ...
  return (
    ...
    >
      ...
      <View style={styles.aiBadge}>
        ...
        <Text style={styles.aiBadgeText}>AI BOOKING ANALYSIS</Text>
      </View>

      <Text style={styles.aiTitle}>Smart Farm Booking Insights</Text>

      <View style={styles.aiGrid}>
        <AIStat label="SUITABLE CROP" value="🌱 Soybean" />

        <AIStat label="FARM AREA" value="2.34 Acres" />

        <AIStat label="GROWTH STAGE" value="Vegetative" />

        <AIStat label="FUEL ESTIMATE" value="8–10 Litres" />
      </View>

      <View style={styles.compatibilityCard}>
        <View style={styles.compatibilityScore}>
          <Text style={styles.compatibilityPercent}>98%</Text>
        </View>
        ...
        <View style={styles.compatibilityTextBox}>
          ...
          <Text style={styles.compatibilityText}>
            Excellent match for your crop, soil type, and current growth stage.
          </Text>
        </View>
      </View>
    </LinearGradient>
...
function PriceRow({ label, value, green }) {
  return (
    <View style={styles.priceRow}>
      ...
      <Text style={[styles.priceValue, green && styles.greenPriceValue]}>
        {value}
      </Text>
    </View>
  );
    ...
    <View style={styles.policyCard}>
      ...
      >
        <View style={styles.policyIconBox}>
          <ShieldCheck size={rf(19)} color={ORANGE} strokeWidth={2.3} />
        </View>
...
function PolicyRow({ Icon, color, text }) {
  return (
    <View style={styles.policyRow}>
      ...
      >
        <Icon size={rf(10)} color="#FFFFFF" strokeWidth={3} />
      </View>
