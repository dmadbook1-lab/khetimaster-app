    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      >
        <View style={styles.heroWrap}>
          <Image
            source={require('../../assets/machinery/provide-hero-success.png')}
            style={styles.hero}
            resizeMode="cover"
          />
        ...
        <Text style={styles.sub}>
          Your machinery is now{'\n'}visible to nearby farmers.
        </Text>

        <View style={styles.infoCard}>
          <View style={styles.phoneIcon}>
            <Phone size={20} color="#1B7A2E" />
          </View>
          <View>
            <Text style={styles.infoTitle}>On Booking</Text>
            <Text style={styles.infoSub}>
              You will get phone & app{'\n'}notification.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.row}>
          ...
          >
            <View style={styles.tractorCircle}>
