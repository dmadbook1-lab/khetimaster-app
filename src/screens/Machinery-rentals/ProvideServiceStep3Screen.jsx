      ...
      >
        <View style={styles.centerWrap}>
          <View style={styles.iconBox}>
            <Tractor size={34} color="#1B7A2E" />
          </View>
          <Text style={styles.title}>Machinery Details</Text>
          <Text style={styles.sub}>
            Fill in basic details of your machinery.
          </Text>
        </View>
        ...
        <View style={styles.locationCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => Alert.alert('Location', 'GPS updated')}
          >
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate('ProvideServiceStep4', {
              ...route.params,
              brand,
              year,
            })
