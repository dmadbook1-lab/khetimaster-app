      ...
      >
        ...
        >
          <View style={styles.heroLabelRow}>
            <View style={styles.heroDotRing}>
              <View style={styles.heroDotInner} />
            </View>
            <Text style={styles.heroLabel}>SMART ALERTS</Text>
          </View>
          <Text style={styles.heroTitle}>Smart Price Alerts</Text>
          <Text style={styles.heroSub}>
            Never miss the perfect selling moment. Set your target and we'll
            alert you instantly.
          </Text>
          <TouchableOpacity
            activeOpacity={0.9}
        ...
        <View style={styles.aiCard}>
          ...
          <Text style={styles.aiBody}>
            Wheat prices are expected to rise 8–12% over the next 2 weeks based
            on seasonal demand. Ideal target:
          </Text>
