              ...
              >
                <View style={styles.conditionIconTop}>
                  <Icon
                    ...
                    strokeWidth={2.3}
                    fill={item.iconFill ? item.iconColor : 'none'}
                  />
                </View>
        ...
        <View style={styles.timelineCard}>
          <View style={styles.timelineHoursRow}>
            {TIMELINE_HOURS.map(h => (
              <Text key={h} style={styles.timelineHour}>
                {h}
              </Text>
            ))}
          </View>
        ...
        <View style={styles.hourList}>
          {HOURLY_DATA.map(hour => (
            <View
              ...
              style={[
                styles.hourCard,
                hour.highlight && styles.hourCardHighlight,
              ]}
            >
